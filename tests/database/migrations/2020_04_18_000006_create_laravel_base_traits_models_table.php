...
class CreateLaravelBaseTraitsModelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('laravel_base_traits_models', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('laravel_base_traits_models');
    }
}
